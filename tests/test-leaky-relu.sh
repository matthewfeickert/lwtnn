...
INPUT=https://github.com/lwtnn/lwtnn-test-data/raw/v9/concat-leakyrelu.tgz
ARCH=architecture.json
VARIABLES=inputs.json
HDF5=weights.h5
LWTNN_JSON_MODEL=model.json
...
echo " == Keras -> json -> Concat and leakyrelu layer unit test ======="
...
echo " -- Testing saved lwtnn model --"
$TEST $TMPDIR/$LWTNN_JSON_MODEL | ./reg-test.py --graph $TMPDIR/$OUTPUT

...
INPUT=https://github.com/lwtnn/lwtnn-test-data/raw/v9/Dense_dropout_functional.tgz
ARCH=model.json
...
OUTPUT=data/dense_dropout_functional-out.json

# Tell the tester what we're doing
echo " == Keras -> json -> C++ dense, droput unit test ======="
echo " Consists of dense and dropout layers with functional API"

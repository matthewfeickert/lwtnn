...
INPUT=https://github.com/lwtnn/lwtnn-test-data/raw/v9/GRU.tgz
ARCH=GRU.json
VARIABLES=variables.json
HDF5=weights/GRU_weights.h5
...
OUTPUT=data/GRU-out.json

# Tell the tester what we're doing
echo " == Testing Keras -> json -> C++ GRU unit test ======="
echo " Consists of: GRU, Maxout and Highway layers"

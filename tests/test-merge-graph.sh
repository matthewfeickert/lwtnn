...
INPUT=https://github.com/lwtnn/lwtnn-test-data/raw/v9/merge-graph.tgz
ARCH=arch.json
VARIABLES=vars.json
HDF5=weights.h5
...
OUTPUT=data/merge-graph-out.json

# Tell the tester what we're doing
echo " == Keras -> json -> C++ merge layer unit test ======="
echo " Consists of a GRU, a merge layer, and two output nodes"
